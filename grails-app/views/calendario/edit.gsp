...
<html>
    ...
    <body>
        ...
        <div id="edit-calendario" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.calendario}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.calendario}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.calendario}" method="PUT">
                <g:hiddenField name="version" value="${this.calendario?.version}" />
                <fieldset class="form">
                    <f:all bean="calendario"/>
                </fieldset>
