...
<html>
    ...
    <body>
        ...
        <div id="show-calendario" class="content scaffold-show" role="main">
            ...
            <f:display bean="calendario" />
            <g:form resource="${this.calendario}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.calendario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
