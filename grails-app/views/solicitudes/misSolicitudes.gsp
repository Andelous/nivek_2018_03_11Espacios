...
<html>
    ...
    <body>
                    ...
                    <g:each in="${solicitudesLista}" var="solicitud">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-link btn-sm text-dark
                                    ${aprobada || enRevision ? '' : 'disabled'}"
                                    data-toggle="modal" data-target="#modalC${solicitud.id}">
                                    <span class="oi oi-print text-primary"></span>
        ...
        <g:each in="${solicitudesLista}" var="solicitud">
            ...
            <div class="modal fade" id="modalC${solicitud.id}" tabindex="-1"
                role="dialog" aria-labelledby="tituloModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <strong>Solicitante</strong>: ${solicitud.usuario.persona.nombres} ${solicitud.usuario.persona.apellidoPaterno} ${solicitud.usuario.persona.apellidoMaterno}
                            <br />
                            <strong>Identificador de solicitud</strong>: ${solicitud.id}
                            <br />
                            <strong>Fecha: </strong>
                            <strong>${solicitud.fecha.format("yyyy-MM-dd")}</strong>,
                            de
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"
                                onclick="document.getElementById('ocultable').style.display='none';print();document.getElementById('ocultable').style.display='block';"
                                data-dismiss="modal"><span class="oi oi-print"></span> Imprimir</button>
                        </div>
